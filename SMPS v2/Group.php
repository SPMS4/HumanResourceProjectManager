...
echo "accept";
        ...
        $taskEventStart = $_POST['Startdatepicker'];
        $taskEventEnd = $_POST['Enddatepicker'];
...
<div id='wrap'>
		...
		<input type="text" id="Title" name="Title0" placeholder="Project Title" >
		<br />
		<br />
		<section> Start Date: </section>
		<aside><input type="text" id="Startdatepicker" name="Startdatepicker" readonly placeholder="dd/mm/yyyy"></aside>
		<br/>
		<br/>
		<section> End Date: </section>
		<aside><input  type="text" id="Enddatepicker" name="Enddatepicker" readonly style="visability:hidden;" placeholder="dd/mm/yyyy"></aside>	
		<br/>
		<br/>
		...
		<input type="submit" id="acceptbut" name="acceptbut"  style="" value="Accept0" />
		<!--<button><input type="submit" id="acceptbut" name="acceptbut" onclick = "pophide()" style="" value="Accept" /></button>-->
		===============================================================================================================================================
		<button type="button" id="cancelbut" onclick = "pophide()" style="">Cancel</button>
		<button><input type="submit" id="cancelbut" name="cancelbut" onclick = "pophide()"style="" value="cancel" /></button>
		
		
		<section id="notecont"> Notes :
		<aside><TEXTAREA id="Note" name="Note"  type="text" rows="10" maxlenght="1000" wrap="hard" placeholder="Enter text here..........."></TEXTAREA></aside></section>
		
		<section id="linkcont"> Relevent Link :
		<aside><input  id="Link" name="Link" type="url" placeholder="www.Website.com"></input></aside></section>
			</form>
		</div>
